...
documentHeight(), window.addEventListener("resize", documentHeight), document.addEventListener("DOMContentLoaded", function () {
  ...
  handleModalOpen = function handleModalOpen(e, t) {
    ...
    }), html.classList.add("something-opened"), t && (void 0 !== t.dataset.modalEnablescroll && html.classList.remove("something-opened"), t.classList.add("modal-opened"), t.dataset.modalName && openedModal.querySelector(".modal-form-title") && (openedModal.querySelector(".modal-form-title").innerHTML = t.dataset.modalName));
  ...
  window.innerWidth > 768 && document.addEventListener("scroll", function () {
    s = window.scrollY, s >= o.clientHeight ? html.classList.contains("header-close") || html.classList.add("header-close") : html.classList.contains("header-close") && html.classList.remove("header-close");
  ...
  var n = document.querySelectorAll(".tabs");
  ...
  (function () {
    var e, t, o, s, n, l, r, a, c, i, d;
    for (s = (e = document.getElementsByClassName("custom-select")).length, t = 0; t < s; t++) {
      for (n = (l = e[t].getElementsByTagName("select")[0]).length, (r = document.createElement("DIV")).setAttribute("class", "select-selected"), (i = document.createElement("SPAN")).innerHTML = l.options[l.selectedIndex].innerHTML, e[t].appendChild(r), r.appendChild(i), i.outerHTML += '<svg width=\'24px\' height="24px" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.96967 8.96967C4.26256 8.67678 4.73744 8.67678 5.03033 8.96967L12 15.9393L18.9697 8.96967C19.2626 8.67678 19.7374 8.67678 20.0303 8.96967C20.3232 9.26256 20.3232 9.73744 20.0303 10.0303L12.5303 17.5303C12.2374 17.8232 11.7626 17.8232 11.4697 17.5303L3.96967 10.0303C3.67678 9.73744 3.67678 9.26256 3.96967 8.96967Z"/></svg>', a = document.createElement("DIV"), d = document.createElement("DIV"), a.setAttribute("class", "select-items select-hide"), d.setAttribute("class", "select-items__items"), o = 0; o < n; o++) (c = document.createElement("DIV")).innerHTML = l.options[o].innerHTML, o === l.selectedIndex && c.setAttribute("class", "same-as-selected"), c.addEventListener("click", function (e) {
        var t, o, s, n, l, r, a;
        for (e.stopPropagation(), r = (n = this.parentNode.parentNode.parentNode.getElementsByTagName("select")[0]).length, l = this.parentNode.parentNode.previousSibling.querySelector("span"), o = 0; o < r; o++) if (n.options[o].innerHTML == this.innerHTML) {
          for (n.selectedIndex = o, l.innerHTML = this.innerHTML, a = (t = this.parentNode.getElementsByClassName("same-as-selected")).length, s = 0; s < a; s++) t[s].removeAttribute("class");
          this.setAttribute("class", "same-as-selected");
          break;
        }
        this.closest("form").submit(), l.click();
      }), d.appendChild(c);
      e[t].appendChild(a), a.appendChild(d), r.addEventListener("click", function (e) {
    ...
    function u(e) {
      var t,
        ...
        l,
        r = [];
      for (t = document.getElementsByClassName("select-items"), o = document.getElementsByClassName("select-selected"), n = t.length, l = o.length, s = 0; s < l; s++) e == o[s] ? r.push(s) : o[s].classList.remove("select-arrow-active");
      for (s = 0; s < n; s++) r.indexOf(s) && t[s].classList.add("select-hide");
    }
    document.addEventListener("click", u);
  })();
  var l = document.querySelectorAll("[data-scrollto]"),
  ...
  var a = document.querySelectorAll(".search-on-site-header"),
    c = document.querySelectorAll(".search-on-site-header input"),
    i = (_JSON$parse = JSON.parse(localStorage.getItem("searchHistory"))) !== null && _JSON$parse !== void 0 ? _JSON$parse : [],
    d = document.getElementById("searchOnSiteInputHeader"),
    u = document.getElementById("headerClearHistorySearch"),
    m = document.getElementById("historySearch");
  for (var _e3 = i.length - 1; _e3 > i.length - 6; _e3--) if (_e3 >= 0) {
    var _t = document.createElement("button");
    _t.innerText = i[_e3], m.appendChild(_t);
  }
  _toConsumableArray(a).forEach(function (e, t) {
    e.addEventListener("submit", function () {
      c[t].value && (i.push(c[t].value), localStorage.setItem("searchHistory", JSON.stringify(i)));
    });
  }), u && u.addEventListener("click", function () {
    i.splice(0, i.length), localStorage.removeItem("searchHistory"), m.innerHTML = "";
  });
