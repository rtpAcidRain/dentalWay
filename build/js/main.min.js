...
documentHeight(), window.addEventListener("resize", documentHeight), document.addEventListener("DOMContentLoaded", function () {
  ...
  _toConsumableArray(document.querySelectorAll(".swiper-container")).forEach(function (e) {
    ...
    new Swiper(e.querySelector(".swiper"), {
      ...
      onAny: function onAny(e) {
        "paginationUpdate" !== e && "afterInit" !== e || (this.pagination.el.classList.contains("swiper-pagination-lock") ? this.el.closest(".swiper-container").classList.add("remove-pagination") : this.el.closest(".swiper-container").classList.remove("remove-pagination"));
      },
      navigation: {
  ...
  (function () {
    var e, t, o, s, n, l, a, r, c, i, d;
    for (s = (e = document.getElementsByClassName("custom-select")).length, t = 0; t < s; t++) {
      for (n = (l = e[t].getElementsByTagName("select")[0]).length, (a = document.createElement("DIV")).setAttribute("class", "select-selected"), (i = document.createElement("SPAN")).innerHTML = l.options[l.selectedIndex].innerHTML, e[t].appendChild(a), a.appendChild(i), i.outerHTML += '<svg width=\'24px\' height="24px" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.96967 8.96967C4.26256 8.67678 4.73744 8.67678 5.03033 8.96967L12 15.9393L18.9697 8.96967C19.2626 8.67678 19.7374 8.67678 20.0303 8.96967C20.3232 9.26256 20.3232 9.73744 20.0303 10.0303L12.5303 17.5303C12.2374 17.8232 11.7626 17.8232 11.4697 17.5303L3.96967 10.0303C3.67678 9.73744 3.67678 9.26256 3.96967 8.96967Z"/></svg>', r = document.createElement("DIV"), d = document.createElement("DIV"), r.setAttribute("class", "select-items select-hide"), d.setAttribute("class", "select-items__items"), o = 0; o < n; o++) (c = document.createElement("DIV")).innerHTML = l.options[o].innerHTML, o === l.selectedIndex && c.setAttribute("class", "same-as-selected"), c.addEventListener("click", function (e) {
        var t, o, s, n, l, a, r;
      ...
      e[t].appendChild(r), r.appendChild(d), a.addEventListener("click", function (e) {
